...
Func Settings()
    ...
    $BTNUserHome = GUICtrlCreateButton(IniRead($Dir_Lang & $lng &".ini", "settings", "09", "NotFound"), 370, 147, 81, 23, 0)
    ...
    $BTNMachineFolder = GUICtrlCreateButton(IniRead($Dir_Lang & $lng &".ini", "settings", "09", "NotFound"), 370, 207, 81, 23, 0)
